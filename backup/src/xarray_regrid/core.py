"""Core regridder classes for xarray-regrid."""
...
class BaseRegridder(abc.ABC):
    ...
    This class defines the interface for all regridder implementations in xarray-regrid.
...
class RectilinearRegridder(BaseRegridder):
    ...
    def __call__(self, data: xr.DataArray | xr.Dataset | None = None, **kwargs) -> xr.DataArray | xr.Dataset:
        ...
        from xarray_regrid.methods import interp, conservative
        from xarray_regrid.utils import format_for_regrid
        from xarray_regrid.regrid import validate_input
    ...
    def stat(
        ...
        """
        from xarray_regrid.utils import format_for_regrid
        from xarray_regrid.methods.flox_reduce import statistic_reduce
    ...
    def most_common(
        ...
        from xarray_regrid.utils import format_for_regrid
        from xarray_regrid.methods.flox_reduce import compute_mode
